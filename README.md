...
- **Free evaluation sample** on GitHub (`5m`) · **11 timeframes** on [getdata.finance](https://getdata.finance/datasets/xagusd) · **1,206,404** `5m` rows in the full archive
- Built for **backtesting**, **algorithmic trading** and **quantitative finance** workflows
- **Weekly refresh** — [getdata.finance](https://getdata.finance) every **Saturday, 8am UTC+0**; GitHub `5m` sample updated in sync

> **Sample on GitHub** · `XAGUSD_5m.csv` (35,589 rows, `2026-03-10` -> `2026-09-09`, 3.34 MB). **Full archive on [getdata.finance](https://getdata.finance/datasets/xagusd)** — **1,206,404** `5m` rows (full `1m`: 5,671,224), **11 timeframes**, `2009-02-24` -> `2026-09-09`.
...
| 5m rows | 35,589 | **1,206,404** |
| Size | 3.34 MB | full ZIP on [getdata.finance](https://getdata.finance/datasets/xagusd) |
...
| --- | --- | --- | --- | --- | --- |
| 2026-03-10T18:35:00+00:00 | 89.327 | 89.476 | 88.915 | 88.919 | 12401 |
| 2026-03-10T18:40:00+00:00 | 88.919 | 89.396 | 88.879 | 89.31 | 8096 |
| 2026-03-10T18:45:00+00:00 | 89.31 | 89.585 | 89.232 | 89.412 | 8506 |
| 2026-03-10T18:50:00+00:00 | 89.412 | 89.673 | 89.356 | 89.43 | 6796 |
| 2026-03-10T18:55:00+00:00 | 89.43 | 89.525 | 89.076 | 89.097 | 7422 |

**Last rows**

| datetime | open | high | low | close | volume |
| --- | --- | --- | --- | --- | --- |
| 2026-09-09T01:40:00+00:00 | 66.005 | 66.045 | 65.983 | 66.003 | 1592 |
| 2026-09-09T01:45:00+00:00 | 66.003 | 66.075 | 65.905 | 65.95 | 1921 |
| 2026-09-09T01:50:00+00:00 | 65.95 | 65.959 | 65.835 | 65.881 | 1494 |
| 2026-09-09T01:55:00+00:00 | 65.881 | 65.972 | 65.84 | 65.916 | 1464 |
...
The complete **XAGUSD** archive on **[getdata.finance](https://getdata.finance/datasets/xagusd)** includes **11 OHLCV timeframes** (1m · 3m · 5m · 15m · 30m · 1H · 4H · 12H · 1D · 3D · 1W) — **1,206,404** rows at `5m`, plus all other timeframes in the same ZIP.
